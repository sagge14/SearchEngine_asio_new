...
namespace search_server {
    ...
    public:
        ...
        listAnswer getAnswer(const string &request) const;

        listAnswers getAllAnswers(const vector<string>& requests) const;
        ...
        [[maybe_unused]] bool getIsUpdateRunning() const;
    };
