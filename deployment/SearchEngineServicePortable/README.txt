...
исполнительных потоков, таймаут одного файла и опцию автоматического заполнения
«краткого содержания» AutoPad PRM. В каждом вопросе Enter или вариант 1 выбирает
рекомендуемое значение. Все введённые значения проверяются помощником.
