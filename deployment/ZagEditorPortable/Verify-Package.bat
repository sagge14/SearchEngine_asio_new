...
rem Mutable machine-specific templates are excluded from checksums.
if /I "%RELATIVE_FILE%"=="data\zag_editor.ini" exit /b 0
if /I "%RELATIVE_FILE%"=="data\EXPORT.INI" exit /b 0
