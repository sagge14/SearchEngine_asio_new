...
*/
    ...
    class InvertedIndex {
        ...
        std::unique_ptr<boost::asio::executor_work_guard<boost::asio::io_context::executor_type>> commit_guard_;
        ...
        std::vector<std::mutex> wordRefsMutex;
        ...
        void commitChunkMap(FileId fileId,
    ...
    public:
        ...
        std::future<void> updateDocumentBase(const std::list<wstring> &vecPaths);
        PostingList getWordCount(const string& word);
        void dictonaryToLog() const;
        explicit InvertedIndex(boost::asio::io_context& _io);
