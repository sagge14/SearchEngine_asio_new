...
либо явно подтверждённая переустановка без экспорта. Старые каталоги остаются
rollback-копией до успешного PING/PONG; при ошибке установщик возвращает их.
